...
//     var data4='<li> <div class="time">2017-08-14</div><div class="lineDot"></div><div class="tit"><span>7</span><h3>莱特币LTC隔离见证带给BTC的四点经验</h3></div></li><li> <div class="time">2017-04-06</div><div class="lineDot"></div><div class="tit"><span>6</span><h3>莱特币LTC基金会在新加坡注册 为核心团队提供财务支持</h3></div></li><li> <div class="time">2016-07-05</div><div class="lineDot"></div><div class="tit"><span>5</span><h3>莱特币LTC官方发布2016年开发路线图，莱特币强势回归？</h3></div></li><li> <div class="time">2015-09-23</div><div class="lineDot"></div><div class="tit"><span>4</span><h3>莱特币5周年</h3></div></li><li> <div class="time">2015-08-26</div><div class="lineDot"></div><div class="tit"><span>3</span><h3>莱特币减半，莱特币创始人李启威发声表祝福</h3></div></li><li> <div class="time">2014-07-21</div><div class="lineDot"></div><div class="tit"><span>2</span><h3>莱特币创始人重提合并挖矿事宜</h3></div></li><li> <div class="time">2011-10-08</div><div class="lineDot"></div><div class="tit"><span>1</span><h3>莱特币发行日期</h3></div></li>';
//     if (data4.length > 0) {
//         $("#coineventtimeline").append(data4);
...
function loadHomeNewCoin() {
    var uri = baseUrl + "api/currency/homenewcoin";
    $.ajax({
        url: uri,
        type: "GET",
        dataType: 'json',
...
function loadHomevolrank() {
    var uri = baseUrl +"api/currency/homevolrank";
    $.ajax({
        url: uri,
        type: "GET",
        dataType: 'json',
...
function loadHomeCoinMaxChange() {
    var uri = baseUrl +"api/currency/HomeCoinMaxChange";
    $.ajax({
        url: uri,
        type: "GET",
        dataType: 'json',
...
function loadconcept(conceptid) {
    //var url = "api.feixiaohao.com/";
    var uri = baseUrl +"api/currency/hotconcept";
